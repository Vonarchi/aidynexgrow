  ...
  return <div className="rounded-[2rem] border border-orange-100 bg-white p-4 shadow-xl shadow-navy-950/10">
    <div className="mb-4 flex items-center justify-between gap-3 px-2">
      <div>
        ...
        {site.websiteUrl && <a href={site.websiteUrl} target="_blank" rel="noreferrer" className="mt-1 inline-flex text-xs font-bold text-royal-700">Based on {site.websiteUrl}</a>}
      </div>
