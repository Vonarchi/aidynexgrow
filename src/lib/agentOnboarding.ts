...
export function createFallbackSiteContext(input: AgentOnboardingInput): GeneratedSiteContext {
  ...
  return {
    ...
    metaDescription: `Preview a professional website for ${businessName}, designed to build credibility, improve discoverability, and capture more customer inquiries.`,
    colors: {
      primary: '#2D2A32',
      accent: '#FFB84D',
      background: '#FFFBF5',
