...
insert into public.service_catalog(name, category, description, benefits, price_type, starting_price, monthly_price, active, featured) values
  ('Business Launch Membership','Membership','DEMO DATA: Required membership for launched websites, including managed hosting, SSL, backups, security monitoring, client portal access, technical maintenance, and platform updates.',array['Required for launch','Managed hosting','SSL included','Daily backups','Security monitoring','Client portal'],'monthly',null,34,true,true),
  ('Accelerate','Launch Support','DEMO DATA: Priority build support with expanded customization, copywriting assistance, premium templates, additional revisions, and stronger launch guidance.',array['Priority build queue','Premium templates','AI-generated business copy','Additional revisions'],'monthly',null,99,true,true),
  ('Scale','Growth','DEMO DATA: Ongoing website updates, maintenance, performance monitoring, advanced SEO, Google Business optimization, CRM, booking, AI chatbot, email automation, analytics, and monthly business review.',array['Monthly website updates','Advanced SEO','CRM integration','AI chatbot','Analytics dashboard'],'monthly',null,249,true,true),
...
insert into public.portfolio_items(title, industry, description, image_url, website_url, featured, published) values
  ...
  ('Hope Forward','Nonprofits','Nonprofit website experience for mission, programs, impact reporting, donations, volunteering, events, and transparency content.','https://image.thum.io/get/width/1200/crop/700/https://non-for-profit.vercel.app/','https://non-for-profit.vercel.app/',false,true),
  ('NOIR VEIL','Entertainment','Cinematic music rollout website for an album universe with releases, videos, tour dates, merch, news, and fan club access.','https://image.thum.io/get/width/1200/crop/700/https://afterhours-alpha.vercel.app/','https://afterhours-alpha.vercel.app/',false,true),
  ('Apex Transit Group','Transportation','Enterprise freight transportation website with services, fleet, coverage, technology, shipment tracking, quote capture, and careers.','https://image.thum.io/get/width/1200/crop/700/https://transportation-cyan.vercel.app/','https://transportation-cyan.vercel.app/',false,true),
  ('Noir Steakhouse','Restaurants','Modern Japanese steakhouse and lounge website with reservations, menu browsing, private events, gallery, locations, and online ordering paths.','https://image.thum.io/get/width/1200/crop/700/https://restuarant-khaki-eight.vercel.app/','https://restuarant-khaki-eight.vercel.app/',false,true),
  ('Lumiere Spa','Beauty and Wellness','Luxury beauty and wellness website with treatments, memberships, team profiles, gift cards, product shop, booking, and consultation flows.','https://image.thum.io/get/width/1200/crop/700/https://beauty-n-wellness-ml4n.vercel.app/','https://beauty-n-wellness-ml4n.vercel.app/',false,true),
  ('Maison Arc','Real Estate','Luxury real estate website with featured listings, neighborhood guides, buyer and seller services, mortgage calculator, and private showing flows.','https://image.thum.io/get/width/1200/crop/700/https://real-estate-ruddy-three.vercel.app/','https://real-estate-ruddy-three.vercel.app/',false,true),
  ('Blackstone & Vale','Professional Services','Premium trial attorney website with practice areas, case results, attorney profiles, client testimonials, process education, FAQ, and consultation intake.','https://image.thum.io/get/width/1200/crop/700/https://law-firm-zip1.vercel.app/','https://law-firm-zip1.vercel.app/',false,true);
