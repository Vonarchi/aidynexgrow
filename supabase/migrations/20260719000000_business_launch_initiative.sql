...
insert into public.portfolio_items(title, industry, description, image_url, website_url, featured, published) values
  ...
  ('Maison Noir','Restaurants','Modern Japanese steakhouse and lounge website with reservations, menu browsing, private events, gallery, locations, and online ordering paths.','https://image.thum.io/get/width/1200/crop/700/https://restuarant-khaki-eight.vercel.app/','https://restuarant-khaki-eight.vercel.app/',false,true),
  ('Maison Lumiere Spa','Beauty and Wellness','Luxury beauty and wellness website with treatments, memberships, team profiles, gift cards, product shop, booking, and consultation flows.','https://image.thum.io/get/width/1200/crop/700/https://beauty-n-wellness-ml4n.vercel.app/','https://beauty-n-wellness-ml4n.vercel.app/',false,true),
